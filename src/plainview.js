...
//     this.player       = new Player(url, config.codecs)
//     this.onSourceOpen = this.onSourceOpen.bind(this)
//
//     /// Stub out everything with no operations until the user configures them
//     const NOP               = () => {}
...
//       this.mute() // we mute so we can autoplay.
...
//
//         console.log('hellloo', player);
//         let mimeCodec = player.codecsString
//         console.log('----', mimeCodec);
//         if ('MediaSource' in window && MediaSource.isTypeSupported(mimeCodec)) {
//           Manson.debug('browser supports codecs')
